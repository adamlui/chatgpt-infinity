    ...
    { ignores: ['**/*cache', '**/*.min.{js,mjs}', '**/package-lock.json'] },
    {
        ...
        languageOptions: {
            ...
            globals: {
                ...
                feedback: 'readonly', i18n: 'readonly', icons: 'writable', infinity: 'readonly', modals: 'writable',
                settings: 'writable', string: 'readonly', styles: 'writable', sync: 'readonly', toggles: 'writable',
